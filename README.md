...
public class TablePanel extends JPanel {
	...
	private class ButtonListener implements ActionListener
	{
	 ...
	 if (buttonX == enter ){
	       ...
	       if (text.equals("p^q") || text.equals("q^p") ){
	       ...
	       else if (text.equals("pvq") || text.equals( "qvp")){ 
	       ...
	       else if (text.equals("~p^q") || text.equals("q^~p")) {
		        

                a = false;

                System.out.println("p\tq\tnot p and q");
                ...
                System.out.println("p\tq\tp and not q");
    ...
    System.out.println("p\tq\tnot p & not q");
    ...
    do {
          ...
          a = !a;
                ...
                else if (text.equals("~pvq") || text.equals("qv~p")) {
		        
                a = false;

                System.out.println("p\tq\tnot p or q");
                ...
                else if (text.equals("pv~q") || text.equals("~qvp")) {
		        
                a = false;

                System.out.println("p\tq\tp or not q");
                ...
                else if (text.equals("~pv~q") || text.equals("~qv~p")) {
    
    a = false;

    System.out.println("p\tq\tnot p or not q");
    ...
    do {
          ...
          a = !a;
                    ...
                    System.out.println("p\tq\tnot p implies q");
    ...
    System.out.println("p\tq\tp implies not q");
    ...
    do {
          ...
          a = !a;
                    ...
                    System.out.println("p\tq\tnot q implies p");
    ...
    System.out.println("p\tq\tq implies not p");
